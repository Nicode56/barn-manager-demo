...
export const lessonSlots: LessonSlot[] = [
  { id: "l1", time: "9:00 AM", available: true, client: "", horse: "", instructor: "", type: "", format: "private" },
  { id: "l2", time: "10:30 AM", available: false, client: "Liam Carter", horse: "Shadow", instructor: "Taylor", type: "Jumping lesson", format: "private" },
  { id: "l3", time: "1:00 PM", available: true, client: "", horse: "", instructor: "", type: "", format: "private" },
  { id: "l4", time: "2:30 PM", available: true, client: "", horse: "", instructor: "", type: "", format: "private" },
